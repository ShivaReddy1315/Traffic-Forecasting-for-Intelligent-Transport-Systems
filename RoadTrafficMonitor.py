...
main = tkinter.Tk()
main.title("Traffic Forecasting for Intelligent Transport Systems") #designing main screen
w=main.winfo_screenwidth()
h=main.winfo_screenheight()
#imgTemp=Image.open("C:\\Users\\nehar\\Downloads\\truck.png")
imgTemp=Image.open("downloads.jpg")
...
font = ('times', 16, 'bold')
title = Label(main, text='Traffic Forecasting for Intelligent Transport Systems', justify=LEFT)
